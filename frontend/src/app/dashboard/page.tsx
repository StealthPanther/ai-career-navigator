...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-black text-white selection:bg-synapse-purple/30 selection:text-white relative font-sans overflow-hidden flex flex-col items-center">
      <AnimatedBackground />
      <FloatingIcons />
      <AnimatedOrbs />
      ...
      {userId && (
        <div className="absolute top-8 right-8 z-20">
          <a
            href="/interview"
            className="px-6 py-3 rounded-lg glass-panel border border-white/20 hover:border-neural-blue/50 transition-all flex items-center gap-2 text-white hover:text-neural-blue font-medium shadow-[0_0_15px_rgba(0,0,0,0.5)]"
          >
            <svg
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 md:py-16 grow flex flex-col">
        ...
        >
          <h1 className="text-6xl md:text-8xl font-black text-white mb-6 tracking-tighter">
            AI Career <span className="text-transparent bg-clip-text bg-gradient-to-r from-neural-blue to-synapse-purple filter drop-shadow-[0_0_15px_rgba(59,130,246,0.5)]">Navigator</span>
          </h1>
          <div className="inline-block">
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto px-6 font-medium leading-relaxed">
              ...
              <span className="text-neural-blue"> AI-powered</span> learning roadmap.
            </p>
          </div>
        </motion.div>
              ...
              <div className="relative flex flex-col items-center gap-2">
                <div
                  className={`
                    ...
                    ${step >= i
                      ? 'bg-neural-blue text-white border-neural-blue shadow-[0_0_15px_rgba(59,130,246,0.5)]'
              ...
              {i < 3 && (
                <div
                  className={`
                    ...
                    ${step > i
                      ? 'bg-gradient-to-r from-neural-blue to-synapse-purple/50' // eslint-disable-line
                      : 'bg-white/10'
                    }
                  `}
                />
